...
//                redisTemplate.delete(CollectionUtils.arrayToList(key));
    ...
    public Object hGet(String key, Long field) {
    ...
    public boolean hSet(String key, Long field, Object value, long time) {

        if (key == null || "".equals(key) || field == null || field == 0L || time < 0) {
            return false;
        }
     ...
     * @return
     */
    public boolean hHasKey(String key, Long field) {
        if (key == null || "".equals(key)) {
            return false;
        }
        return redisTemplate.opsForHash().hasKey(key, field);
