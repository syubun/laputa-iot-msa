package com.laputa.iot.common.core.base.enums;
...
public enum LaputaHttpStatus {
    ...
    LaputaHttpStatus(Integer code, String message) {
        this.code = code;
     ...
     * @return the enum
     */
    public static LaputaHttpStatus getEnum(int code) {
        for (LaputaHttpStatus ele : LaputaHttpStatus.values()) {
            if (ele.getCode() == code) {
                return ele;
            }
        }
