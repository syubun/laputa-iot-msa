 ...
 */
@Slf4j
public class LaputaSentinelInvocationHandler implements InvocationHandler {
	...
	LaputaSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			LaputaSentinelInvocationHandler other = (LaputaSentinelInvocationHandler) obj;
